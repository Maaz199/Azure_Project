...
df = pd.read_csv("C:/Users/maazm/Downloads/Participants_Data_PLD/train.csv")
...
url = 'http://138.91.136.177:80/api/v1/service/aks-service/score'
api_key = os.environ.get('Azure_Project')    # Replace this with the API key for the web service
